...
<div id="page-content-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="line-behind-text"><span>Form Elements</span></h2>
                <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-base">
                    <div class="panel-heading">
                        <h3 class="panel-title">Main Form</h3>
                        <span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i></span>
                    </div>
                    <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="select-group" class="selectpicker">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="select-multiple" class="selectpicker" multiple>
                                            <option>Mustard</option>
                                            <option>Ketchup</option>
                                            <option>Relish</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label for="select-multiple-limit">Select Multiple With Limit</label>
                                        <select id="select-multiple-limit" class="selectpicker" multiple data-max-options="2">
                                            <option>Mustard</option>
                                            <option>Ketchup</option>
                                            <option>Relish</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label for="select-group-limit">Select Group With Limit</label>
                                        <select id="select-group-limit" class="selectpicker" multiple  data-max-options="2">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title" id="selectModalLabel">Select</h4>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="select-multiple-modal">Select Multiple</label>
                                                        <select id="select-multiple-modal" class="selectpicker" multiple>
                                                            <option>Mustard</option>
                                                            <option>Ketchup</option>
                                                            <option>Relish</option>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="select-multiple-limit-modal">Select Multiple With Limit</label>
                                                        <select id="select-multiple-limit-modal" class="selectpicker" multiple data-max-options="2">
                                                            <option>Mustard</option>
                                                            <option>Ketchup</option>
                                                            <option>Relish</option>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="select-group-limit-modal">Select Group With Limit</label>
                                                        <select id="select-group-limit-modal" class="selectpicker" multiple  data-max-options="2">
                                                            <optgroup label="Condiments" data-max-options="2">
                                                                <option>Mustard</option>
                                                                <option>Ketchup</option>
                                                                <option>Relish</option>
            ...
            <div class="col-md-6">
                <div class="panel panel-base">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="select2-group">Select2 Group</label>
                            <select id="select2-group" class="form-control select2">
                        ...
                        <div class="form-group">
                            <label for="select2-multiple">Select2 Multiple Select</label>
                            <select id="select2-multiple" class="select2 form-control" multiple="multiple" data-tags="true" data-placeholder="Select an option" data-allow-clear="true">
                                <optgroup label="Alaskan/Hawaiian Time Zone">
                                    <option value="AK">Alaska</option>
                                    <option value="HI">Hawaii</option>
                                </optgroup>
                        ...
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#select2">
                            Select2 on Modal
                        </button>

                        <!-- Modal -->
                        <div class="modal fade" id="select2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title" id="myModalLabel">Select2</h4>
                                    </div>
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <select class="select2" data-placeholder="Select an option">
                                                <optgroup label="Alaskan/Hawaiian Time Zone">
                                                    <option value="AK">Alaska</option>
                                                    <option value="HI">Hawaii</option>
                                                </optgroup>
                                        ...
                                        <div class="form-group">
                                            <select class="select2" multiple="multiple" data-placeholder="Select an option">
                                                <optgroup label="Alaskan/Hawaiian Time Zone">
                                                    <option value="AK">Alaska</option>
                                                    <option value="HI">Hawaii</option>
                                                </optgroup>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="panel panel-base">
                    <div class="panel-heading">
                        <h3 class="panel-title">Radio Button</h3>
                        <span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i></span>
                    </div>
                    <div class="panel-body">
